...
public:
	bool IsBombTicking()
	{
		return (bool)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_PlantedC4", "m_bBombTicking"));
	}
	...
	C_BasePlayer* GetBombDefuser()
	{
		auto hDefuser = m_hBombDefuser();
		return (C_BasePlayer*)g_EntityList->GetClientEntityFromHandle(hDefuser);
	}

	bool IsDefusing()
	{
		auto def = GetBombDefuser();
		if (def)
			return true;
		else
			return false;
...
public:
	...
	NETVAR(bool,    m_bReloadVisuallyComplete,   "DT_WeaponCSBase",		"m_bReloadVisuallyComplete");
