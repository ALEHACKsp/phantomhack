...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0,0), const char* idStr = "");       
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, const char* tooltip = "", const char* _id = "");
    IMGUI_API bool          CheckboxFlags(const char* label, unsigned int* flags, unsigned int flags_value);
    IMGUI_API bool          RadioButton(const char* label, bool active);
	IMGUI_API bool			RadioButtonEx(const char* label, bool active, const char* tooltip = "");
    IMGUI_API bool          RadioButton(const char* label, int* v, int v_button);
	IMGUI_API bool			RadioButtonEx(const char* label, int* v, int v_button, const char* tooltip = "");
	...
	IMGUI_API bool			ColorEdit3INT(const char* label, int col[3]);
	IMGUI_API bool			ColorEdit4INT(const char* label, int col[4]);
...
enum ImGuiInputTextFlags_
{
	...
	ImGuiInputTextFlags_NoLabel				= 1 << 21
};
